...
class MenuOptions extends StatefulWidget {
  ...
  const MenuOptions({Key? key, required this.onSelected, this.showcaseKey}) : super(key: key);
            ...
            child: Material(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    _buildItem('unfavorite', 'Unfavorite', Icon(Icons.favorite_border)),
                    const Divider(height: 5),
                    _buildItem('see_more', 'See More', Icon(Icons.visibility)),
                    const Divider(height: 5),
                    _buildItem('move', 'Move', Icon(Icons.move_to_inbox)),
                  ],
                ),
              ),
            ),
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Expanded(
              child: Text(label, style: AppTextStyles.size10W400Black),
            ),
            BorderedIconButton(
              icon: icon,
              iconSize: 9,
